...
Assert-False (Test-IsNewCommentLine -Content '### `slug` <!-- x -->' -FilePath '.github/pr-quality-gate/HIGH-TIER-SLUGS.md') 'HIGH-TIER-SLUGS.md is path-excluded (generated byte-identical projection of the catalog)'
