...
generate_output() {
    ...
    printf '\n'
    printf 'GENERATED FILE — do not hand-edit. Regenerated by `scripts/sync-critical-rules.ps1` from `pattern-catalog.md`.\n'
    printf '\n'
    ...
    printf '          keep_reason: <≤12 words; MUST add information beyond comment text>\n'
